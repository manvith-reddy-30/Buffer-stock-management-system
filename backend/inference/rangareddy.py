...
MODEL_PATH = BASE_DIR / "lstms" / "rangareddy-tomato_price_prediction_model.h5"
SCALER_PATH = BASE_DIR / "scaler" / "rangareddy.save"
...
def predict_next_7_days(prices: list[float]) -> list[float]:
    """
    Predict the next 7 days of tomato prices using LSTM .
